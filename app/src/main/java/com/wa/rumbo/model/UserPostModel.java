...
public class UserPostModel implements Serializable
{
    ...
    @Expose
    private List<UserPostModel.GetAllPost_Data> object = null;
    ...
    public List<UserPostModel.GetAllPost_Data> getObject() {
        return object;
    }

    public void setObject(List<UserPostModel.GetAllPost_Data> object) {
        this.object = object;
    }
